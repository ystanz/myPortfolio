...

  {
    ...
    rules: {
      ...
      'prettier/prettier': [
        'error',
        {
          singleQuote: true, // Para padronizar o uso das aspas simples em strings, e não as aspas duplas
          trailingComma: 'none', // Torna não ser mais obrigatório o uso da vírgula após o último elemento de uma lista, matriz ou objeto
          semi: false // Assim dizemos que não vamos usar o ponto e vírgula no fim das expressões.
        }
      ]
    }
  },
